...
namespace LotServer
{
    public partial class MqttServerForm
    {
        ...
        {
            nlogger.Info("topic subscribed." + topicArg.ToString());
        }

        private async Task UnSubscribeTopic(MqttServerClientUnsubscribedTopicEventArgs topicArg)
        {
            nlogger.Info("topic unSubscribed." + topicArg.ToString());
        }

        private void Started(EventArgs e)
        {
            nlogger.Info("server started. " + e.ToString());
        ...
        {
            nlogger.Info("server stopped. " + e.ToString());
            this.BeginInvoke(new EventHandler(delegate
            {
